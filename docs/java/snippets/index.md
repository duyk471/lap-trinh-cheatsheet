...
- [Một số đoạn Java cho các vấn đề hàng ngày](van-de-hang-ngay.md)
- [Java Design Patterns](https://java-design-patterns.com/)
- [GitHub Java Corpus](https://groups.inf.ed.ac.uk/cup/javaGithub/) - Rất nhiều dự án Java để học. Bạn có thể tải luôn [top_projects.tar.gz 5.3MB](https://groups.inf.ed.ac.uk/cup/javaGithub/top_projects.tar.gz).
