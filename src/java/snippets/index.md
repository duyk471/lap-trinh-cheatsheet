# Kho lưu trữ Java snippets

Lấy từ [iluwatar/30-seconds-of-java](https://github.com/iluwatar/30-seconds-of-java) và rất nhiều nguồn khác nhau để tổng hợp và sử dụng.

Repo này sẽ không chứa đầy đủ toàn bộ các phần tệp và thư mục khác của dự án (Bao gồm `src/test`, `pom.xml` và tương tự). Bạn vui lòng ghé qua Repository gốc để nghịch nha.

Một số các *kho lưu trữ* khác:

- [Một số đoạn Java cho các vấn đề hàng ngày](kho-khac/van-de-hang-ngay.md)
- [Java Design Patterns](https://java-design-patterns.com/)
- [GitHub Java Corpus](https://groups.inf.ed.ac.uk/cup/javaGithub/) - Rất nhiều dự án Java để học. Bạn có thể tải luôn [top_projects.tar.gz 5.3MB](https://groups.inf.ed.ac.uk/cup/javaGithub/top_projects.tar.gz) hoặc nếu đường dẫn trên không được thì [bấm vào đây](archive/top_projects.tar.gz)

**Lưu ý:** Các phần nội dung được lưu trong Repository này chỉ mang tính chất lưu trữ và chia sẻ. Mình chỉ là người tổng hợp lại thôi.
